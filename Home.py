...
loaded_model_sleep = pickle.load(open('https://githubusercontent.com/LaxmiVatsalyaDaita/CMSE830/main/Models/sleep_rf_model.sav', 'rb')) # 'rb' means reading the binary format

from tensorflow.keras.models import load_model

# Load the saved model
loaded_model_heart = load_model('https://githubusercontent.com/LaxmiVatsalyaDaita/CMSE830/main/Models/heart_risk_model.h5')

with open('https://githubusercontent.com/LaxmiVatsalyaDaita/CMSE830/main/Models/scaler.pkl', 'rb') as file:
